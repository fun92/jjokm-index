...
CACHE="/private/tmp/jjokkom-index-cache"

pkill -f "/JjokkomIndex.app/Contents/MacOS/JjokkomIndex" 2>/dev/null || true
pkill -f "쪼꼼 인덱스.app/Contents/MacOS/JjokkomIndex" 2>/dev/null || true
